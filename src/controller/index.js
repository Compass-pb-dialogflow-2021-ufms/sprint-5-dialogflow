...
const main = async (req, res) => {
    try {
        ...
        let mapping = {
            ...
            'Help Intent':  () => dialog.answer(intents.menuLoop()),
            ...
            'Menu - Diagnostic Intent': () => dialog.answer(intents.diagnostic()),
                ...
                'Diagnostic Intent - Medicine':       () => dialog.answer(intents.diagnostic__medicine()),
                    'Diagnostic Intent - Medicine - Improvement':    () => dialog.answer(intents.diagnostic__medicine__improvement()),
                        'Diagnostic Intent - Improvement - Fallback':   () => dialog.answer(intents.diagnostic__improvement__fallback()),
            ...
            'Result Intent':            () => dialog.answer(intents.result()),
            'Start Diagnostic Intent':        () => dialog.answer(intents.startDiagnostic()) //Re-added just so diagnostic has a proper start
        }
        mapping[displayName]()
