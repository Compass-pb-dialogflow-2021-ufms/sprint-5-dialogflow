module.exports = {
    prevencao: {
            mensagens: [`- Cuidados Básicos\n- Cuidados Básicos para profissionais da Saúde`, `Quais medidas de prevenção você deseja ver ?`],
            quickReplies: ["Cuidados Básicos", "Cuidados Básicos para profissionais da Saúde"]
    },
    cuidadosBasicosCivis: {
        ...
        \nQuando precisar sair de sua residência, sempre utilize máscaras caseiras feitas de tecido.`,
            `Você também pode assistir o video informativo do Ministério da Saúde :https://www.youtube.com/watch?v=cvdskDhw-Ps .Posso ajudar em algo mais ?`
        ],
        quickReplies: ["Menu", "Não, era só isso"]
    },
    cuidadosBasicosProfissionais: {
        ...
        \nAlém disso, para a realização de procedimentos que gerem aerossolização de secreções respiratórias como intubação, aspiração de vias aéreas ou indução de escarro, deve ser utilizado precaução por aerossóis, com uso de máscara N95.`, 'Posso ajudar em algo mais?'],
            quickReplies: ["Menu", "Não, era só isso"]
        }
}
